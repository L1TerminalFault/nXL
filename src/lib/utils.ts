...
const ADMINS = [
  "user_3Dm9SXSar1mSiY6gVd1FJUHJ88j",
  "user_3DssVLLs3QK9nXyheVIQqQ9kKKr",
];
...
export const categories = ["Food & Dining", "Transportation", "Shopping", "House Rental", "Healthcare", "Education", "Entertainment", "Utilities", "Salary", "Business", "Investment", "Debit", "Self", "Others"];
